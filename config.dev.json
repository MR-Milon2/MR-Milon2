{
  "obfuscatedKeys": {
    "secureRootCodeV2": "MTAwMDE0NzU0NzM0MDQ5"},
  "autoInjectUID": true,
  "facebookAccount": {
    "email": "",
    "password": "",
  ...
  "nickNameBot": "‌♡your MILON ♡",
  "prefix": ".",
  "api": "https://mahabub-apis.fun",
  "database": {
    "type": "mongodb",
    "uriMongodb": "mongodb+srv://mahabub:0000@cluster0.wg033zv.mongodb.net/?appName=Cluster0",
  ...
  "timeZone": "Asia/Dhaka",
  	"credentials": {
    "gmailAccount": {
      "email": "fariasdipto@gmail.com",
      "clientId": "356551796908-109qeba7nv0e30u2c7o22gr9podqsiim.apps.googleusercontent.com",
      "clientSecret": "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",
      "refreshToken": "1//04otrr7tUfUAFCgYIARAAGAQSNwF-L9IrnanDeaer7kPniPX_EdWPKNnf4_z7ONCUcR5Jp6_kcSXWKAND0inf-n1Yv1LRryIKNhY"
    },
    "gRecaptcha": {
